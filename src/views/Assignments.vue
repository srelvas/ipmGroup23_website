...
const navigation = [
  { name: 'Assignment 1', href: '#', icon: ClipboardListIcon, current: true },
  { name: 'Assignment 2', href: '#', icon: ClipboardListIcon, current: false },
  { name: 'Assignment 3', href: '#', icon: ClipboardListIcon, current: false },
